    ...
    <div className="clients-page-wrapper" style={{
      ...
      <div className="view-container" style={{
        ...
        <div className="view-header" style={{ marginBottom: '8px' }}>
          ...
          <p className="view-description" style={{ color: 'var(--text-secondary)', fontSize: '16px', margin: 0 }}>Lista de clientes e contatos comerciais consolidados a partir dos agendamentos.</p>
        </div>
      ...
      <div className="clients-table-container" style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
          {filteredClients.length > 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <span style={{ color: 'var(--text-primary)', fontWeight: '500', fontSize: '15px' }}>{client.nome}</span>
                  </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexGrow: 1, padding: '40px', color: 'var(--text-secondary)' }}>
